...
import { FaUser, FaEnvelope, FaPhone, FaWhatsapp, FaRegFile } from 'react-icons/fa';
            ...
            <div className="space-y-4">
                ...
                <div className="flex items-center space-x-3">
                    ...
                    <div className="flex-1">
                        ...
                        <span className="block">{user?.createdAt ? new Date(user.createdAt).toLocaleDateString() : "N/A"}</span>
                    </div>
                </div>
                        ...
                        <ul className="list-disc ml-5">
                            {user.isSubcription.map(subscription => (
                                <li key={subscription._id} className="flex items-center">
                                    ...
                                    {subscription.name} {/* Change this based on your actual service schema */}
                                </li>
                            ))}
                        </ul>
                    ) : (
