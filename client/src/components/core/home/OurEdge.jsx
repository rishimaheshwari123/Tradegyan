  ...
  return (
    <div className=" lg:w-[80%] w-11/12 mx-auto  text-[#323232]">
      ...
      <div className="lg:hidden text-center w-full my-10">
        ...
        <div className=" lg:min-h-[120px] min-h-[90px] absolute lg:min-w-[120px] min-w-[90px] lg:min-w-[120px] min-w-[90px]  m border-t-[30px] border-r-[30px]  max-w-[120px] lg:border-t-[40px] lg:border-r-[40px] border-[#f5c300] lg:top-[50px] lg:right-[100px] top-[10px] right-[10px]" >

        </div>

        <div className=" lg:min-h-[120px] min-h-[90px] absolute lg:min-w-[120px]  min-w-[90px]  max-w-[120px] lg:border-b-[40px] lg:border-l-[40px] border-b-[30px] border-l-[30px]  border-[#f5c300] lg:bottom-[50px] lg:-left-[20px] bottom-0 left-0" >
