      ...
      <div className="relative mt-3">
        {traderData ? (
          traderData.map((data) => (
            <div
              key={data.name}
              className="container mx-auto p-4 text-gray-800 lg:w-[70%] grid lg:grid-cols-2 gap-4"
            >
              <div className="flex flex-col gap-3">
                <h1 className="text-3xl lg:text-4xl font-bold mb-4 text-center text-blue-500">
                  {data?.name}
                </h1>
                ...
                <h2 className="text-xl lg:text-2xl font-semibold mb-2 mt-4">
                  Features:
                </h2>
                ...
                <p className="italic mb-4 text-[13px] lg:text-sm">
              ...
              <div className=" h-[calc(100vh-100px)]">
                ...
                {data.image && (
                  <div className="flex flex-col justify-center items-center gap-4">
                    <h3 className="text-3xl lg:text-4xl text-[#6c75aa] font-semibold">
                      Risko Meter
                    </h3>
                    <img
                      src={data.image}
